...
FROM SYS.ALL_TABLES";
		...
		public const string GetTableDetailsBaseCommand =
@"SELECT
	CASE 
...
WHERE
	...
	(
		...
		public const string GetTableInMemoryAllocatedBytesCommand = "SELECT INMEMORY_SIZE, BYTES, BYTES_NOT_POPULATED, POPULATE_STATUS FROM V$IM_SEGMENTS WHERE OWNER = :OWNER AND SEGMENT_NAME = :SEGMENT_NAME AND PARTITION_NAME IS NULL";
