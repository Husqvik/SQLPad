...
END;";
		...
		public const string IndexDescription = "SELECT ALL_INDEXES.OWNER, INDEX_NAME, INDEX_TYPE, UNIQUENESS, COMPRESSION, PREFIX_LENGTH, LOGGING, CLUSTERING_FACTOR, STATUS, NUM_ROWS, SAMPLE_SIZE, LAST_ANALYZED, DEGREE, SEGMENT_TYPE, BLOCKS, BYTES FROM ALL_INDEXES JOIN DBA_SEGMENTS ON ALL_INDEXES.OWNER = DBA_SEGMENTS.OWNER AND INDEX_NAME = SEGMENT_NAME WHERE TABLE_OWNER = :TABLE_OWNER AND TABLE_NAME = :TABLE_NAME ORDER BY ALL_INDEXES.OWNER, INDEX_NAME";
