...
namespace SqlPad.Oracle
{
	...
	public static class OracleGrammarDescription
	{
		...
		internal static readonly ICollection<string> ReservedWordsPlSqlDeclaration = new HashSet<string> { "AS", "AT", "BEGIN", "CASE", "COLUMNS", "CURSOR", "DECLARE", "END", "EXCEPTION", "FETCH", "FUNCTION", "GOTO", "IF", "INDEXES", "PRAGMA", "PROCEDURE", "SUBTYPE", "TYPE", "WHEN" };
		
		internal static readonly ICollection<string> ReservedWordsPlSqlBody = new HashSet<string> { "AS", "AT", "BEGIN", "CASE", "CLOSE", "COLUMNS", "COMMIT", "DECLARE", "END", "EXCEPTION", "EXIT", "FETCH", "GOTO", "IF", "INDEXES", "LOOP", "OPEN", "PRAGMA", "PROCEDURE", "RAISE", "RETURN", "ROLLBACK", "SAVEPOINT", "WHEN", "WHILE" };
