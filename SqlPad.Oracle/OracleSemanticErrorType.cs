namespace SqlPad.Oracle
{
	public static class OracleSemanticErrorType
	{
		...
		public const string InvalidToLobUsage = "TO_LOB can be used only with LONG or LONG RAW type in CREATE TABLE AS SELECT or INSERT INTO command";
		public const string DistinctOptionNotAllowedForThisFunction = "DISTINCT option not allowed for this function";
	...
	public static class OracleSuggestionType
	{
		...
		public const string ImplicitConversionWarning = "Implicit conversion between {0} and {1}";
	}
}