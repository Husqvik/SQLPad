...
END;";
		...
		public const string SelectSqlPlanMonitorCommandText = "SELECT PLAN_LINE_ID, STARTS, OUTPUT_ROWS, IO_INTERCONNECT_BYTES, PHYSICAL_READ_REQUESTS, PHYSICAL_READ_BYTES, PHYSICAL_WRITE_REQUESTS, PHYSICAL_WRITE_BYTES, WORKAREA_MEM, WORKAREA_MAX_MEM, WORKAREA_TEMPSEG, WORKAREA_MAX_TEMPSEG FROM V$SQL_PLAN_MONITOR WHERE SID = :SID AND SQL_ID = :SQL_ID AND SQL_EXEC_ID = :SQL_EXEC_ID AND SQL_EXEC_START = :SQL_EXEC_START ORDER BY PLAN_LINE_ID";
