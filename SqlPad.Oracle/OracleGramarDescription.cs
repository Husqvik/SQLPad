...
namespace SqlPad.Oracle
{
	...
	public static class OracleGrammarDescription
	{
		...
		internal static readonly ICollection<string> ReservedWordsPlSql = new HashSet<string> { "BEGIN", "CASE", "DECLARE", "END", "EXCEPTION", "IF", "WHEN" };
