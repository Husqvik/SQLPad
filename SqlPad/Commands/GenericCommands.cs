...
namespace SqlPad.Commands
{
	public static class GenericCommands
	{
		...
		public static RoutedCommand ExecuteDatabaseCommandCommand = new RoutedCommand("ExecuteDatabaseCommand", typeof(Grid), new InputGestureCollection { new KeyGesture(Key.F9), new KeyGesture(Key.Enter, ModifierKeys.Control) });
		public static RoutedCommand ExecuteDatabaseCommandWithActualExecutionPlanCommand = new RoutedCommand("ExecuteDatabaseCommandWithActualExecutionPlan", typeof(Grid), new InputGestureCollection { new KeyGesture(Key.F9, ModifierKeys.Shift), new KeyGesture(Key.Enter, ModifierKeys.Control | ModifierKeys.Shift) });
